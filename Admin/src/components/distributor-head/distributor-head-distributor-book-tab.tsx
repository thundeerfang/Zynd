...
export function DistributorHeadDistributorBookTab({
  book,
  sips,
  purchases,
}: {
  ...
  const filteredSips = useMemo(() => {
    ...
    return sips.filter((row) => {
      ...
      return [row.clientName, row.schemeName].join(" ").toLowerCase().includes(query);
    });
      ...
      >
        ...
        <TabsContent value="sips" className="mt-0 space-y-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <AdminSearchInput
              ...
              placeholder="Search SIPs by client or scheme"
              value={sipSearch}
              onChange={(event) => {
        ...
        <TabsContent value="lumpsum" className="mt-0 space-y-4">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <AdminSearchInput
              containerClassName="max-w-sm"
              placeholder="Search purchases by client or scheme"
