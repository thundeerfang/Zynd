...
import { matchesManagerClientSearch } from "@/lib/distributor-head-queries";
...
export function DistributorHeadManagerClientsTab({
  clients,
}: {
  ...
  const filtered = useMemo(() => {
    return clients.filter((row) => {
      if (!matchesManagerClientSearch(row, search)) return false;
