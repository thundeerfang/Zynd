    ...
    <div className="relative isolate min-h-full w-full">
      ...
      <div className="relative z-10 flex min-h-full w-full flex-col gap-3 text-left">
        ...
        <div className="space-y-1.5">
          ...
          {secondaryDescription ? (
            <p className="text-caption leading-relaxed text-primary-foreground/85 sm:text-compact">
              {secondaryDescription}
            </p>
          ) : null}
        </div>
    ...
    <section id={id} className={cn("space-y-3", className)}>
      ...
      <div className="grid w-full min-w-0 grid-cols-2 gap-3">
        {steps.map((step, index) => {
          const config = DEFAULT_STEP_CONFIG[index];
          ...
          return (
            ...
            >
              <HowItWorksStepContent
                ...
                secondaryDescription={step.secondaryDescription}
