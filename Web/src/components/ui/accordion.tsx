  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "group flex w-full flex-1 items-center justify-between gap-3 rounded-[var(--radius-control)] py-3.5 text-left text-compact font-medium transition-colors outline-none hover:bg-muted/30 focus-visible:ring-2 focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50",
          className,
        )}
        {...props}
      >
